...
export default function ChoreCard({ chore, isDragging, onDragStart, onDragEnd }: ChoreCardProps) {
  ...
  const dueDateInfo = chore.dueDate ? formatDueDate(new Date(chore.dueDate)) : null;
  ...
  return (
    <>
      ...
      >
        ...
        {/* Description */}
        {chore.description && (
          <p className="text-sm text-gray-600 mb-3 line-clamp-2">{chore.description}</p>
        )}

        {/* Due Date */}
        {dueDateInfo && (
          <div className={`flex items-center space-x-1 text-xs ${dueDateInfo.color} mb-2`}>
